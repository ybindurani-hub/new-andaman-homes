...
export const STATES_DATA = [
  { name: 'Andaman & Nicobar Islands', cities: ['Port Blair', 'Havelock', 'Neil Island', 'Diglipur', 'Mayabunder'] },
  { name: 'Andhra Pradesh', cities: ['Visakhapatnam', 'Vijayawada', 'Guntur', 'Nellore'] },
  ...
  { name: 'Tamil Nadu', cities: ['Chennai', 'Coimbatore', 'Madurai', 'Adambakkam'] }
];
